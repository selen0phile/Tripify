...
-- Get ratings count from an object

SELECT GET_RATING_COUNT('trip',10,1) AS ONE, GET_RATING_COUNT('trip',10,2) AS TWO, GET_RATING_COUNT('trip',10,3) AS THREE, GET_RATING_COUNT('trip',10,4) AS FOUR, GET_RATING_COUNT('trip',10,5) AS FIVE, ROUND(GET_AVG_RATING('trip',10),2) AS AVG_RATING
FROM DUAL;

-- Get Avg Rating of an Object 
