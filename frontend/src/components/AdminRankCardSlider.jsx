...
export default function AdminRankCardSlider({ title, info, rating, price, href, imgs, rank, subtitle }) {
    ...
    return (
        <Box height={'100%'} width={'100%'} position={'absolute'}>
            <Box p={4}>
            <center>
            <FaMedal color={medal_color} size="48"/><Text fontSize="4xl" color={medal_color} fontWeight="bold">{rank_title}</Text>
            <Text color={medal_color} fontSize={'2xl'}>{subtitle}</Text>
            </center>
            </Box>
